(self["webpackChunkgoogle_login"] = self["webpackChunkgoogle_login"] || []).push([["node_modules_codetrix-studio_capacitor-google-auth_dist_esm_web_js"],{
...
"use strict";
module.exports = JSON.parse('{"appId":"io.googlelogin.ap","name":"google-login","bundleWebRuntime":false,"npmClient":"npm","webDir":"wwww","plugins":{"SplashScreen":{"launchShowDuration":0},"capacitor":{}},"GoogleAuth":{"scopes":["profile","email"],"serverClientId":"657334795088-n1546abb4jst4uaqnu99fel63csegcc1.apps.googleusercontent.com","forceCodeForRefreshToken":true},"type":"angular"}');
...
/* harmony import */ var _ionic_config_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../ionic.config.json */ 7910);
...
class GoogleAuthWeb extends _capacitor_core__WEBPACK_IMPORTED_MODULE_0__.WebPlugin {
    ...
    platformJsLoaded() {
        gapi.load('auth2', () => {
            ...
            if (_ionic_config_json__WEBPACK_IMPORTED_MODULE_1__.plugins.GoogleAuth != null && _ionic_config_json__WEBPACK_IMPORTED_MODULE_1__.plugins.GoogleAuth.scopes != null) {
                clientConfig.scope = _ionic_config_json__WEBPACK_IMPORTED_MODULE_1__.plugins.GoogleAuth.scopes.join(' ');
            }
    ...
    async signIn() {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                try {
                    needsOfflineAccess = _ionic_config_json__WEBPACK_IMPORTED_MODULE_1__.plugins.GoogleAuth.serverClientId != null;
                }
                catch (_a) {
                }
